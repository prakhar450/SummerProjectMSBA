...
train_dataset = CustomDataset(csv_path=csv_paths['train'], img_dir=img_dir, transform=transform)
test_dataset = CustomDataset(csv_path=csv_paths['val'], img_dir=img_dir, transform=transform)
